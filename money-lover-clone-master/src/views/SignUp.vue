<template>
  <div id="signup" class="mx-auto py-12 w-10/12 lg:w-2/6 md:w-1/2">
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" v-on:submit.prevent="onSubmit">
      ...
      <div class="mb-6">
        <label class="block text-gray-700 text-sm font-bold mb-2" for="password">Re-Password</label>
        <input
        ...
        >Confirm password must be the same as password</p>
      </div>
      <div class="flex sm:flex-row flex-col items-center justify-between mb-6 md:mb-16">
        ...
        <div inline-block align-baseline>
          Have an account?
          <router-link to="/login" class="font-bold text-sm text-blue-500 hover:text-blue-800">Login</router-link>
        </div>
      </div>
